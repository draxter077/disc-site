...
export default function main(m){
    ...
    else if(m == "fireproof"){pColor="rgb(136, 73, 30)";sColor="rgb(255, 255, 255)"}
    else if(m == "littlethings"){pColor="rgb(171, 55, 55)";sColor="rgb(255, 255, 255)"}
    else if(m == "neverletyougo"){pColor="rgb(92, 45, 131)";sColor="rgb(255, 255, 255)"}
